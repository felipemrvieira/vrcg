...
try {
		Debug.PushSubsStack("Base_Resize (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xloadingindicator.class, "_mainloop" /*void*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("Draw_Arc1 (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("Draw_Arc2 (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Draw_FiveLines1 (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,95);
...
try {
		Debug.PushSubsStack("Draw_PacMan (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,131);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getWidth"),_dotr,_progress,(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterX"),b4xloadingindicator.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 0))}, "--*",2, 0))),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterY")),(Object)(BA.numberCast(float.class, _dotr)),(Object)(__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xloadingindicator.class, "_setalpha" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(255),RemoteObject.createImmutable(200),_progress}, "-*",1, 0))))),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
try {
		Debug.PushSubsStack("Draw_SingleCircle (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles1 (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles2 (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("Hide (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Initialize (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("MainLoop (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,42);
...
public ResumableSub_MainLoop(xevolution.vrcg.devdemov2400.b4xloadingindicator parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
try {
		Debug.PushSubsStack("SetAlpha (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("Show (b4xloadingindicator) ","b4xloadingindicator",78,__ref.getField(false, "ba"),__ref,56);
