...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("xevolution.vrcg.devdemov2400.common");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("common"), "xevolution.vrcg.devdemov2400.common");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("xevolution.vrcg.devdemov2400.common"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
