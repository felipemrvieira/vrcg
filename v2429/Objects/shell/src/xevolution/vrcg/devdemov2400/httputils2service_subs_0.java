...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,134);
if (RapidSub.canDelegate("completejob")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","686376454",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
_job.runClassMethod (xevolution.vrcg.devdemov2400.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,105);
if (RapidSub.canDelegate("hc_responseerror")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("xevolution.vrcg.devdemov2400.httpjob");
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,86);
if (RapidSub.canDelegate("hc_responsesuccess")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("xevolution.vrcg.devdemov2400.httpjob");
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,97);
if (RapidSub.canDelegate("response_streamfinish")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,27);
if (RapidSub.canDelegate("service_create")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","685917703",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","685917704",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,62);
if (RapidSub.canDelegate("service_destroy")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,58);
if (RapidSub.canDelegate("service_start")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",65,httputils2service.processBA,httputils2service.mostCurrent,68);
if (RapidSub.canDelegate("submitjob")) { return xevolution.vrcg.devdemov2400.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
Debug.ShouldStop(8192);
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (xevolution.vrcg.devdemov2400.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 80;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.ShouldStop(32768);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (xevolution.vrcg.devdemov2400.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };
