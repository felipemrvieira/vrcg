...
public class b4xcombobox2 {
    public static RemoteObject myClass;
	public b4xcombobox2() {
	}
    public static PCBA staticBA = new PCBA(null, b4xcombobox2.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"cmbBox",_ref.getField(false, "_cmbbox"),"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"xui",_ref.getField(false, "_xui")};
}
}