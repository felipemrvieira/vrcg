...
public class force_gc {
    public static RemoteObject myClass;
	public force_gc() {
	}
    public static PCBA staticBA = new PCBA(null, force_gc.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _t = RemoteObject.declareNull("anywheresoftware.b4a.agraham.threading.Threading");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"r",_ref.getField(false, "_r"),"t",_ref.getField(false, "_t")};
}
}