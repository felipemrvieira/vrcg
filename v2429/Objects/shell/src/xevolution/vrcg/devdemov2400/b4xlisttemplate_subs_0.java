...
b4xlisttemplate._xdialog = RemoteObject.createNew ("xevolution.vrcg.devdemov2400.b4xdialog");__ref.setField("_xdialog",b4xlisttemplate._xdialog);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,76);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(b4xlisttemplate.__c.getField(true,"True")));
 }else {
...
try {
		Debug.PushSubsStack("DialogClosed (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("Initialize (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Resize (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("SelectItem (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,59);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (xevolution.vrcg.devdemov2400.b4xdialog.class, "_setbuttonstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",__ref.getField(false,"_selecteditems" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, __ref.getField(true,"_multiselectionminimum" /*RemoteObject*/ ))))));
...
try {
		Debug.PushSubsStack("Show (b4xlisttemplate) ","b4xlisttemplate",77,__ref.getField(false, "ba"),__ref,41);
...
public ResumableSub_Show(xevolution.vrcg.devdemov2400.b4xlisttemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
if (true) break;
