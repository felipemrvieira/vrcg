...
public class tinifile {
    ...
    public static PCBA staticBA = new PCBA(null, tinifile.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _fmap = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
public static RemoteObject _fdirname = RemoteObject.createImmutable("");
public static RemoteObject _ffilename = RemoteObject.createImmutable("");
public static RemoteObject _fautoflush = RemoteObject.createImmutable(false);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"FAutoFlush",_ref.getField(false, "_fautoflush"),"FDirName",_ref.getField(false, "_fdirname"),"FFileName",_ref.getField(false, "_ffilename"),"FMap",_ref.getField(false, "_fmap")};
}
}