...
public static RemoteObject _root = RemoteObject.declareNull("xevolution.vrcg.devdemov2400.b4xeval._parsednode");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"Error",_ref.getField(false, "_error"),"ESC_POS",_ref.getField(false, "_esc_pos"),"mCallback",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"Nodes",_ref.getField(false, "_nodes"),"NUMBER_TYPE",_ref.getField(false, "_number_type"),"OPERATOR_TYPE",_ref.getField(false, "_operator_type"),"OperatorLevel",_ref.getField(false, "_operatorlevel"),"ParseIndex",_ref.getField(false, "_parseindex"),"root",_ref.getField(false, "_root")};
}
}