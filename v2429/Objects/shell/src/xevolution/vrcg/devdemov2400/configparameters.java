...
public class configparameters {
    ...
    public static PCBA staticBA = new PCBA(null, configparameters.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _cfg_allow_front_camera = RemoteObject.createImmutable(0);
public static RemoteObject _cfg_copy_image_to_gallery = RemoteObject.createImmutable(0);
public static RemoteObject _cfg_take_picture_always_as_new = RemoteObject.createImmutable(0);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CFG_ALLOW_FRONT_CAMERA",_ref.getField(false, "_cfg_allow_front_camera"),"CFG_COPY_IMAGE_TO_GALLERY",_ref.getField(false, "_cfg_copy_image_to_gallery"),"CFG_TAKE_PICTURE_ALWAYS_AS_NEW",_ref.getField(false, "_cfg_take_picture_always_as_new"),"ConfigFileName",_ref.getField(false, "_configfilename"),"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos")};
}
}