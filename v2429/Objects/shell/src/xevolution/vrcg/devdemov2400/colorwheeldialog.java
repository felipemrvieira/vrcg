...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"ColorResult",_ref.getField(false, "_colorresult"),"cvsColors",_ref.getField(false, "_cvscolors"),"cvsOverlay",_ref.getField(false, "_cvsoverlay"),"DateUtils",_ref.getField(false, "_dateutils"),"dialog",_ref.getField(false, "_dialog"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"pnlColors",_ref.getField(false, "_pnlcolors"),"pnlOverlay",_ref.getField(false, "_pnloverlay")};
}
}