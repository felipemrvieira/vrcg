...
public class helpdescriptors implements IRemote{
	public static helpdescriptors mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public helpdescriptors() {
		mostCurrent = this;
	}
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, helpdescriptors.class);
    static {
		mostCurrent = new helpdescriptors();
        remoteMe = RemoteObject.declareNull("xevolution.vrcg.devdemov2400.helpdescriptors");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("helpdescriptors"), "xevolution.vrcg.devdemov2400.helpdescriptors");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("xevolution.vrcg.devdemov2400.helpdescriptors"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static RemoteObject _db_requests_actions = RemoteObject.createImmutable("");
