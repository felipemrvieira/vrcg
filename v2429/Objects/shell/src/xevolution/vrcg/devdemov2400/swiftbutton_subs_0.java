...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.swiftbutton.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.swiftbutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,71);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(_inside));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("Update (swiftbutton) ","swiftbutton",90,__ref.getField(false, "ba"),__ref,116);
