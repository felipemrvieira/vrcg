...
public class expandedlistview {
    ...
    public static PCBA staticBA = new PCBA(null, expandedlistview.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _mbase = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _mbaseparent = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _msvparent = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
public static RemoteObject _mupdowniconexists = RemoteObject.createImmutable(false);
public static RemoteObject _mupdowniconindex = RemoteObject.createImmutable(0);
public static RemoteObject _idata = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"AnimationDuration",_ref.getField(false, "_animationduration"),"CallBack",_ref.getField(false, "_callback"),"DateUtils",_ref.getField(false, "_dateutils"),"DefaultTextBackgroundColor",_ref.getField(false, "_defaulttextbackgroundcolor"),"DefaultTextColor",_ref.getField(false, "_defaulttextcolor"),"DesignerLabel",_ref.getField(false, "_designerlabel"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"EventName",_ref.getField(false, "_eventname"),"FireScrollChanged",_ref.getField(false, "_firescrollchanged"),"horizontal",_ref.getField(false, "_horizontal"),"iData",_ref.getField(false, "_idata"),"items",_ref.getField(false, "_items"),"LastReachEndEvent",_ref.getField(false, "_lastreachendevent"),"mBase",_ref.getField(false, "_mbase"),"mBaseParent",_ref.getField(false, "_mbaseparent"),"mDividerSize",_ref.getField(false, "_mdividersize"),"mFirstVisibleIndex",_ref.getField(false, "_mfirstvisibleindex"),"mLastVisibleIndex",_ref.getField(false, "_mlastvisibleindex"),"MonitorVisibleRange",_ref.getField(false, "_monitorvisiblerange"),"msvParent",_ref.getField(false, "_msvparent"),"mUpDownIconExists",_ref.getField(false, "_mupdowniconexists"),"mUpDownIconIndex",_ref.getField(false, "_mupdowniconindex"),"PressedColor",_ref.getField(false, "_pressedcolor"),"ScrollBarsVisible",_ref.getField(false, "_scrollbarsvisible"),"su",_ref.getField(false, "_su"),"sv",_ref.getField(false, "_sv"),"xui",_ref.getField(false, "_xui")};
}
}