...
public class tabstripviewpagerextendet {
    public static RemoteObject myClass;
	public tabstripviewpagerextendet() {
	}
    public static PCBA staticBA = new PCBA(null, tabstripviewpagerextendet.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos")};
}
}