...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,84);
...
__ref.runClassMethod (xevolution.vrcg.devdemov2400.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,33);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,114);
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",88,__ref.getField(false, "ba"),__ref,147);
