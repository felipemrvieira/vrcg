...
try {
		Debug.PushSubsStack("Base_Resize (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("CmbBox_ItemClick (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,157);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xcombobox.class, "_raiseevent" /*void*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("GetItem (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("getSelectedIndex (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getSelectedItem (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,121);
...
Debug.JustUpdateDeviceLine();
_i = __ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("i", _i);Debug.locals.put("i", _i);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xcombobox.class, "_getitem" /*RemoteObject*/ ,(Object)(_i));
...
try {
		Debug.PushSubsStack("getSize (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("IndexOf (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,87);
...
try {
		Debug.PushSubsStack("Initialize (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("RaiseEvent (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,137);
...
public ResumableSub_RaiseEvent(xevolution.vrcg.devdemov2400.b4xcombobox parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("index", _index);Debug.locals.put("index", _index);
...
try {
		Debug.PushSubsStack("SetItems (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,59);
...
__ref.runClassMethod (xevolution.vrcg.devdemov2400.b4xcombobox.class, "_setselectedindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));};
...
try {
		Debug.PushSubsStack("setSelectedIndex (b4xcombobox) ","b4xcombobox",71,__ref.getField(false, "ba"),__ref,106);
