...
public static RemoteObject _api_result_state = RemoteObject.createImmutable(false);
public static RemoteObject _job_url = RemoteObject.createImmutable("");
public static RemoteObject _job_funcreturn = RemoteObject.createImmutable("");
public static RemoteObject _job_savelocal = RemoteObject.createImmutable(false);
public static RemoteObject _job_target = RemoteObject.declareNull("Object");
public static RemoteObject _job_params = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
public static RemoteObject _job_data = RemoteObject.createImmutable("");
public static RemoteObject _job_done_result = RemoteObject.createImmutable(0);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"API_RESULT_STATE",_ref.getField(false, "_api_result_state"),"DateUtils",_ref.getField(false, "_dateutils"),"Encoding",_ref.getField(false, "_encoding"),"ESC_POS",_ref.getField(false, "_esc_pos"),"job_data",_ref.getField(false, "_job_data"),"job_done_result",_ref.getField(false, "_job_done_result"),"job_funcReturn",_ref.getField(false, "_job_funcreturn"),"job_params",_ref.getField(false, "_job_params"),"job_savelocal",_ref.getField(false, "_job_savelocal"),"job_target",_ref.getField(false, "_job_target"),"job_url",_ref.getField(false, "_job_url")};
}
}