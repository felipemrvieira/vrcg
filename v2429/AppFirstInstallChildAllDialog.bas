...
Sub DownloadAllDataTable(activName As Object, tablename As String, starting As Int, totalcounter As Int )
...
'	CURRENT_Positions = dialogPositions
	...
	DownloadStart(tablename, starting, totalcounter)
...
'===========================================================================================
Sub MakeTableMaps(tablename As String, starting As Int, ending As Int) As String
	Dim params As Map
	params.Initialize
	params.Clear
...
'===========================================================================================
Sub DownloadStart(tablename As String, starting As Int, ending As Int)
	Dim ServerAddress As String = $"https://${ShareCode.APP_DOMAIN}.${ShareCode.APPL_HOST}/api/orion/download/table/items"$
	Dim Job As HttpJob
	Job.Initialize("",Me)
	Job.PostString(ServerAddress, MakeTableMaps(tablename, starting, ending) )
...
'	End If
'	
'	CURRENT_Positions.Text = $"${CURRENT_COUNTER}/${END_COUNTER}"$
